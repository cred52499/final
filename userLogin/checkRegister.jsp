    ...
    <%
		...
		try { 
			...
			if(con.isClosed()){
				...
				String sql = "INSERT INTO `member` (`memberUsername`, `memberPassword`, `memberName`, `memberEmail`, `memberBirthday`, `memberGender`, `memberLeftNearsighted`, `memberRightNearsighted`) " +
							 "VALUES ('"+username+"', '"+password+"', '"+name+"', '"+email+"', '"+birthday+"', '"+gender+"', '"+lnearsighted+"', '"+rnearsighted+"')";
