		...
		<section>
			<div class="fedback">
                <form id="feedback" action="../admin/comment.jsp" method="POST">
					...
					<input type="hidden" name="href" value="coloredLens/goodspage.jsp?productID=<%=productID%>">
            ...
            <div class="comments1">
                ...
                <div class="comments">
					<%
						sql = "SELECT * FROM `comment` WHERE `category` = 'coloredlens' AND `productID` = '"+productID+"' ORDER BY commentID DESC";
