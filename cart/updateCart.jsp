...
try { 
	...
	if(con.isClosed()){
		...
		while(dataset.next()){
			...
			String sql4 = "INSERT INTO `order` (`orderDate`, `productID`, `productCategory`, `orderQty`, `memberID`, `memberAddress`, `memberPhoneNum`, `status`, `subtotal`, `cartID`) " +
	...
	con.close();	
	request.sendRedirect("../member/member.jsp");
